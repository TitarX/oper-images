 ...
 * @author TitarX
 */
public class DialogErrorDownloadFile extends JDialog
{

    FiltersForm ff;

    /** Creates new form DialogErrorOpenFile */
    public DialogErrorDownloadFile(Frame parent,String head,boolean modal,String str,FiltersForm ff)
    {
    ...
    private void initComponents() {
        ...
        buttonDownload.setText("Загрузить другой файл");
